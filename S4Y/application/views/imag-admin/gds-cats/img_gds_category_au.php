                        ...
                        <form name="add_form" method="POST">
                            <table class="sc_block_content_table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="img_cat_name" style="width: 400px;" value="<? echo $v_params['img_gds_cat']['name']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="sc_contact_name">
                                    ...
                                    <td>
                                        <select name="parent_cat">
                                            <option <? if($v_params['img_gds_cat']['pid']) { echo "selected"; } ?> value="">Нет родительской</option>
                                            <? foreach ($v_params['img_gds_cats'] as $imgGDScat): ?>
                                                <option <? if($v_params['img_gds_cat']['pid'] == $imgGDScat['id']) { echo "selected"; } ?> value="<? echo $imgGDScat['id']; ?>"><? echo $imgGDScat['name']; ?></option>
                                            <? endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
