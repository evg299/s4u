                        ...
                        <form name="del_form" method="POST">
                            <table class="sc_block_content_table">
                                <tr>
                                    ...
                                    <td>
                                        <? echo $v_params['img_gds_cat']['name']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="sc_contact_name" style="width: 150px;">
                                    ...
                                    <td>
                                        <? echo $v_params['img_gds_parent_cat']['name']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="sc_contact_name" style="width: 150px;">
                                    ...
                                    <td>
                                        <select name="move_cat">
                                            <? foreach ($v_params['img_gds_cats'] as $imgGDScat): ?>
                                                <option value="<? echo $imgGDScat['id']; ?>"><? echo $imgGDScat['name']; ?></option>
                                            <? endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <? else: ?>
                                <div>Удаление не возможно, т.к. это последняя категория</div>
                            <? endif; ?>
                        </form>
                    </div>
                </td>
