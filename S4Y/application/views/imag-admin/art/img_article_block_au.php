...
<html>
    <head>
        ...
        <!-- <script src="/assets/local/js/tabs.js"></script> -->
                    ...
                    <div class="sc_block">
                        ...
                        <form name="send_block_form" method="post">
                            ...
                            <div id="tabs" style="margin-top: 9px;">
                                ...
                                <div id="tabs-1">
                                    <textarea name="text_content" style="margin: 3px;  width: 680px; height: 500px;"><? echo $v_params['img_blog_art_block']['text_content']; ?></textarea>
                                </div>
                                <div id="tabs-2">
                                    <div align="center">
                                        <img id="selected_img" style="margin: 0 auto; 
                                             ...
                                             border-radius: 4px;
                                             min-height: 100px;
                                             min-width: 100px;" src="/thumbPicture?pict_id=<? echo $v_params['img_blog_art_block']['img_picture_id']; ?>" />
                                        <input id="selected_img_id" type="hidden" name="pict_id" value="<? echo $v_params['img_blog_art_block']['img_picture_id']; ?>" />
                                    </div>

                                    <div>Подпись изображения</div>
                                    <input type="text" name="img_desk" style="margin: 3px;  width: 680px;" value="<? echo $v_params['img_blog_art_block']['pict_desc']; ?>"/>
                            ...
                            <table style="margin: 0 auto;">
                                <tr>
                                    ...
                                    <td><input style="width: 100px;" type="number" name="order" value="<? echo $v_params['img_blog_art_block']['order_in_art']; ?>"></td>
                                </tr>
                            </table>
