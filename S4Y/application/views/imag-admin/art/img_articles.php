...
<html>
    <head>
        <title><?= $v_params['sys_name'] ?> | <?= $v_params['img_name']; ?> | Управление статьями</title>
            ...
            <tr style="vertical-align: top;">
                ...
                <td id="center">
                    ...
                    <div class="sc_block" align="right">
                        <a href="ART?act=add"><div class="button" style="width: 120px;">Написать статью</div></a>
                    </div>
                    <div class="sc_block">
                        <div class="sc_block_head">
                            Поиск статей
                                ...
                                <table class="<? if($cnt == ++$iter) {echo "last_preview_table";} else {echo "preview_table";} ?>">
                                    <tr valign="top">
                                        <td style="width: 255px;">
                                            <a href="ART?id=<? echo $img_blog_art['id']; ?>&act=upd"><img class="preview_table_img" src="/thumbPicture?<? echo PICT_PARAM_NAME; ?>=<? echo $img_blog_art['main_pict_id']; ?>"  /></a>
                                        </td>
                                        <td>
                                            <div class="blog_text_preview">
                                                <div class="blog_text_title_preview"><a href="ART?id=<? echo $img_blog_art['id']; ?>&act=upd"><? echo $img_blog_art['name']; ?></a></div>
                                                <div class="blog_date_preview">
                                                    Дата создания: <?php echo $img_blog_art['creation_date']; ?>
                                                </div>
                                                <div>
                                                    <?php echo $img_blog_art['preview']; ?>
                                                </div>
                                                <div class="blog_read_all">
                                                    <a href="ART?id=<? echo $img_blog_art['id']; ?>&act=upd">Редактировать >></a>
                                                    <br />
                                                    <a href="ART?id=<? echo $img_blog_art['id']; ?>&act=del">Удалить >></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
