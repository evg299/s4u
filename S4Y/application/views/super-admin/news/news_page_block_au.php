                    ...
                    <div class="sc_block">
                        ...
                        <form name="send_block_form" method="post">
                            ...
                            <div id="tabs" style="margin-top: 9px;">
                                ...
                                <div id="tabs-1">
                                    <textarea name="text_content" style="margin: 3px;  width: 680px; height: 500px;"><? echo $v_params['ssp_block']['text_content']; ?></textarea>
                                </div>
                                <div id="tabs-2">
                                    <div align="center">
                            ...
                            <table style="margin: 0 auto;">
                                <tr>
                                    ...
                                    <td><input style="width: 100px;" type="number" name="order" value="<? echo $v_params['ssp_block']['order_in_art']; ?>"></td>
                                </tr>
                            </table>
